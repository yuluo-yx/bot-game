...
export class Snake extends AcGameObject {
    constructor(info, gamemap) {
        ...
        this.cells = [new Cell(info.r, info.c)];//存放蛇身体cells[0]存放蛇头
        ...
        if (this.id === 1) this.eye_direction = 2;//左下角蛇初始向上，右上角向下
    ...
    update_move() {
        ...
        if (distance < this.eps) {//走到目标点
            ...
            const move_distance = this.speed * this.timedelta / 1000;//每两帧间走过的距离
