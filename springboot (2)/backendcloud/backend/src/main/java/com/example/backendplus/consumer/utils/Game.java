...
import com.example.backendplus.pojo.Record;
...
public class Game extends Thread {
    ...
    private String status = "playing";// ->finish
    private String loser = ""; //all:平局,a:a输,b:b输
    private final static String addBotUrl = "http://159.75.69.201:1236/bot/add/";

    private ReentrantLock lock = new ReentrantLock();

    public Game(Integer rows, Integer cols, Integer inner_walls_count, Integer idA, Bot botA,
    ...
    private boolean nextStep() {//等待两位下一步操作
    ...
    private void sendMove() {//向两个客户端传递信息
        lock.lock();
        try {
            JSONObject resp = new JSONObject();
            resp.put("event", "move");
